...
define i8* @buraaq_fn_read(i8* %p0) {
...
define i1 @buraaq_fn_write(i8* %p0, i8* %p1) {
  %l0 = alloca i8*, align 8
...
define i1 @buraaq_fn_exists(i8* %p0) {
  %l0 = alloca i8*, align 8
  store i8* %p0, i8** %l0, align 8
bb0:
  ret i1 0
...
define %struct_File @buraaq_fn_open(i8* %p0) {
  %l0 = alloca i8*, align 8
  %l1 = alloca %struct_File, align 8
  store i8* %p0, i8** %l0, align 8
bb0:
  %t1 = alloca %struct_File, align 8
  %t2 = load i8*, i8** %l0, align 8
  %t3 = getelementptr inbounds %struct_File, %struct_File* %t1, i32 0, i32 0
  store i8* %t2, i8** %t3, align 8
  %t4 = load %struct_File, %struct_File* %t1, align 8
  store %struct_File %t4, %struct_File* %l1, align 8
  %t5 = load %struct_File, %struct_File* %l1, align 8
  ret %struct_File %t5
}
